...
DOCUMENTATION = """
---
module: hitachi_block_restoreTI
short_description: Restores a Thin Image pair.
description:
  - This module allows you to restore a Thin Image pair.
options:
  management_address:
    description:
