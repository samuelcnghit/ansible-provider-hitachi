...
---
module: add_paths
short_description: Adds paths to a compute node.
description:
  - This module adds paths to a compute node on a Hitachi Virtual Storage Platform One SDS Block storage system.
options:
  management_address:
    description:
...
EXAMPLES = '''
  - name: Add paths to a Compute Node
    add_paths:
