...
DOCUMENTATION = """
---
module: hitachi_block_createTI
short_description: Creates a Thin Image pair.
description:
  - This module allows you to create a Thin Image pair.
options:
  management_address:
    description:
  ...
  mu_number:
    description:
      - Specify the mirror unit number in the range from 0 to 1023, default is auto assign.
    required: false
"""
...
def hitachi_block_main():
    module_args = dict(
        ...
        mu_number=dict(type='int', required=False)
    )
