...
DOCUMENTATION = """
---
module: hitachi_block_splitTI
short_description: Splits a Thin Image pair.
description:
  - This module allows you to split a Thin Image pair.
options:
  management_address:
    description:
