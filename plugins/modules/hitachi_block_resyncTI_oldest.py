...
DOCUMENTATION = """
---
module: hitachi_block_resyncTI_oldest
short_description: Resyncs the oldest Thin Image pair.
description:
  - This module allows you to resync the oldest Thin Image pair.
options:
  management_address:
    description:
...
EXAMPLES = """
- name: Restore the oldest ThinImage pair
...
def hitachi_block_main():
    ...
    try:
        ...
        response = executors.resync_ti_oldest()
